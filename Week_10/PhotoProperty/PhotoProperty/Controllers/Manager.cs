...
namespace PhotoProperty.Controllers
{
    public class Manager
    {
        ...
        {
            return Mapper.Map<IEnumerable<VehicleBase>>(ds.Vehicles.OrderBy(v => v.Model).ThenByDescending(v => v.MSRP));
        }
        ...
        public VehiclePhoto VehiclePhotoGetById(int id)
        {
            var o = ds.Vehicles.Find(id);

            return (o == null) ? null : Mapper.Map<VehiclePhoto>(o);
        }
        ...
        public VehicleBase VehicleAdd(VehicleAdd newItem)
        {
            ...
            // Attention - 6 - Handle the uploaded photo...
            ...
            return (addedItem == null) ? null : Mapper.Map<VehicleBase>(addedItem);
        }
