...
namespace SecurityClaimsIntro.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // Attention - 05 - New "Index" method in the account controller
        ...
        // ############################################################
        // Attention - 06 - New account details action/method
        ...
        {
            // ############################################################
            // Attention - 04 - Account/Login code was modified
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // ############################################################
                    // Attention - 02 - Claims-aware "Register" method to handle user-submitted data
